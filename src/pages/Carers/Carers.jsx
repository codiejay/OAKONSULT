    ...
    <>
      ...
      <div id='Carer_goals'>
        ...
        <p>
          ...
          factors and so much more! I have learnt however, that the decisions we
          make or are not able to make through our individual journeys in this
          terrain go a long way to determine the ‘what’, ‘how’, and ‘when’ of
          our lives.
        </p>
      </div>
      <div id='forYou'>
        ...
        <div className='courses'>
          <div className='carersCourse '>
            ...
            <div className='courseContainer'>
              ...
              <div className='getCourse'>GET THIS COURSE</div>
            </div>
          </div>
          <div className='carersCourse'>
            <div className='blueTag'></div>
